package nl.tinyaii.tinyclaim.flags;
...
public final class Flags {
    ...
    static {
        ...
        // 权限
        PRI_FLAGS.put("build", true);
        PRI_FLAGS.put("interact", true);
        PRI_FLAGS.put("container", true);
        PRI_FLAGS.put("pvp", false);
        PRI_FLAGS.put("attack-monster", true);
        PRI_FLAGS.put("attack-animal", true);
        PRI_FLAGS.put("use-elytra", true);
        PRI_FLAGS.put("use-redstone", true);
        PRI_FLAGS.put("enter", true);
        PRI_FLAGS.put("chest-access", true);
    }
