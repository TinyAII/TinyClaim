package nl.tinyaii.tinyclaim.storage;
...
public class Storage {
    ...
    public Storage(TinyClaimPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    /** 保存全局权限成员（owner -> [成员列表]） */
    public void saveGlobalAdmins(nl.tinyaii.tinyclaim.data.ClaimManager manager) {
        YamlConfiguration yml = load();
    ...
    /** 加载全局权限成员 */
    public void loadGlobalAdmins(nl.tinyaii.tinyclaim.data.ClaimManager manager) {
        YamlConfiguration yml = load();
